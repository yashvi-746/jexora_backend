...
exports.getShipments = async (req, res) => {
  try {
    const shipments = await Shipment.find({ owner: req.user.id })
...
exports.getShipmentById = async (req, res) => {
  try {
    const s = await Shipment.findOne({ _id: req.params.id, owner: req.user.id })
      .populate("orderId", "orderNumber status");
...
exports.deleteShipment = async (req, res) => {
  try {
    const deleted = await Shipment.findOneAndDelete({ _id: req.params.id, owner: req.user.id });
